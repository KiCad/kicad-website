...
would like to make it easy for everyone to deduce which documentaiton
...
incrementing integer which is incremented whenever the documentaiton
...
old release triplet (read KiCad aligned documentaiotn version), then
...
documentaiton releases to be updated independent of the KiCad release
...
needed to generate the documentaiton output.
