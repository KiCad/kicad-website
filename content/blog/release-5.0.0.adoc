...
After almost a year after the last released update of KiCad 4.0.7, we
would now like to present a new and improved KiCad 5.0 release!

The stable release verison 5.0.0 is made from the
