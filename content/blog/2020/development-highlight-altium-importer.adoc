...
If you want to give the board import a spin, simply download the latest KiCad nightly and take it for a spin. Feel free to link:help/report-an-issue/[report any issues].   
