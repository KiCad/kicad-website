...
A single symbol should be drawn for each footprint variations of a fully specified symbol (or atomic part). Other variations (as listed above) do not require their own symbol but should be added as an alias.
