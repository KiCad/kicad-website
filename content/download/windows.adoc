...
- http://downloads.kicad-pcb.org/windows/stable/kicad-product-4.0.4-x86_64.exe[Windows 64-bit (x86_64)]
- http://downloads.kicad-pcb.org/windows/stable/kicad-product-4.0.4-i686.exe[Windows 32-bit (i686)]
