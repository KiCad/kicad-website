...
<div class="list-group download-list-group">
	<a class="list-group-item" href="https://kicad-downloads.s3.cern.ch/windows/stable/kicad-5.0.2_1-x86_64.exe">
		<img src="/img/about/cern-logo.png" /> CERN
	</a>
	<a class="list-group-item" href="http://www2.futureware.at/~nickoe/kicad-downloads-mirror/windows/stable/kicad-5.0.2_1-x86_64.exe">
		Futureware
	</a>
</div>
++++
...
<h4>Download mirrors</h4>
<div class="list-group download-list-group">
	<a class="list-group-item" href="https://kicad-downloads.s3.cern.ch/windows/stable/kicad-5.0.2_1-i686.exe">
		<img src="/img/about/cern-logo.png" /> CERN
	</a>
	<a class="list-group-item" href="http://www2.futureware.at/~nickoe/kicad-downloads-mirror/windows/stable/kicad-5.0.2_1-i686.exe">
		Futureware
	</a>
</div>
++++
