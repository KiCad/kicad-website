...
- http://downloads.kicad-pcb.org/windows/stable/kicad-5.0.1_3-x86_64.exe[Windows 64-bit (x86_64)] http://www2.futureware.at/~nickoe/kicad-downloads-mirror/windows/stable/kicad-5.0.1_3-x86_64.exe[[mirror]]
- http://downloads.kicad-pcb.org/windows/stable/kicad-5.0.1_3-i686.exe[Windows 32-bit (i686)] http://www2.futureware.at/~nickoe/kicad-downloads-mirror/windows/stable/kicad-5.0.1_3-i686.exe[[mirror]]
