...
- http://downloads.kicad-pcb.org/windows/stable/kicad-4.0.6-x86_64.exe[Windows 64-bit (x86_64)]
- http://downloads.kicad-pcb.org/windows/stable/kicad-4.0.6-i686.exe[Windows 32-bit (i686)]
