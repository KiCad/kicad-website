...
* link:https://launchpad.net/kicad/4.0/4.0.3/+download/kicad-4.0.3.tar.xz[Source code]
* link:http://downloads.kicad-pcb.org/docs/kicad-doc-4.0.3.tar.gz[Precompiled docs], https://github.com/KiCad/kicad-doc/releases/tag/4.0.3[doc sources]
* link:https://github.com/KiCad/kicad-i18n/releases/tag/4.0.3[Kicad-i18n]
* link:http://downloads.kicad-pcb.org/libraries/kicad-library-4.0.3.tar.gz[Kicad-library repo]
* link:http://downloads.kicad-pcb.org/libraries/kicad-footprints-4.0.3.tar.gz[Footprint repos]

For the moment you are supposed to use the following options to set
the version string:

  -DKICAD_REPO_NAME=stable -DKICAD_BUILD_VERSION=4.0.3
