...
=== Old Stable
The 2013 stable release of KiCad is in the official repository for linux mint. It is not recommended
for new designs.
If you wish to install it search for `KiCad` in the Software Manager or execute the following in a terminal:
