...
|Bahasa Indonesia | link:http://docs.kicad-pcb.org/stable/id/getting_started_in_kicad.html[HTML] link:http://docs.kicad-pcb.org/stable/id/getting_started_in_kicad.pdf[PDF] link:http://docs.kicad-pcb.org/stable/id/getting_started_in_kicad.epub[ePub]
|===
...
|Bahasa Indonesia | link:http://docs.kicad-pcb.org/stable/id/kicad.html[HTML] link:http://docs.kicad-pcb.org/stable/id/kicad.pdf[PDF] link:http://docs.kicad-pcb.org/stable/id/kicad.epub[ePub]
|===
