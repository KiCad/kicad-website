...
|Русский | link:http://docs.kicad-pcb.org/ru/pl_editor.html[HTML] link:http://docs.kicad-pcb.org/ru/pl_editor.pdf[PDF] link:http://docs.kicad-pcb.org/ru/pl_editor.epub[ePub]
|===
