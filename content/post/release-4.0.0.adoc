...
This a complete list of all contributors who have submitted at least one patch since 18th May 2013 or in other words the old stable. We thank you for your contributions no matter how small.
