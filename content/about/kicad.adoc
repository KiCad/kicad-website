...
Digi-Key Electronics purchased the kicad.org domain name which was being used to serve malware
and redirected it to the main KiCad website at kicad-pcb.org.
